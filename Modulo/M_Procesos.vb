Module M_Procesos
    Public Usuario As String = "Ninguno"

    Public Sub bitacora(Actividad As String, Afectado As String)
        Frm_Login.TBL_BitacoraTableAdapter.PA_Agregar_Bitacora(Usuario, Actividad, Afectado)
    End Sub
