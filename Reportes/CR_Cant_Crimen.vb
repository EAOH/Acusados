...
Public Class CR_Cant_Crimen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_fiscal_para_acusados.CR_Cant_Crimen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_Cant_Crimen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_Cant_Crimen = New CR_Cant_Crimen()
        rpt.Site = Me.Site
        Return rpt
    End Function
