...
Public Class CR_Abogado_A
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_fiscal_para_acusados.CR_Abogado_A.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_Abogado_A
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_Abogado_A = New CR_Abogado_A()
        rpt.Site = Me.Site
        Return rpt
    End Function
