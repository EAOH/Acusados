...
Public Class CR_Defendidos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_fiscal_para_acusados.CR_Defendidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_Defendidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_Defendidos = New CR_Defendidos()
        rpt.Site = Me.Site
        Return rpt
    End Function
