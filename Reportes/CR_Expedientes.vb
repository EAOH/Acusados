...
Public Class CR_Expedientes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_fiscal_para_acusados.CR_Expedientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_Expedientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_Expedientes = New CR_Expedientes()
        rpt.Site = Me.Site
        Return rpt
    End Function
